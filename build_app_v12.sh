#!/usr/bin/env bash
# v12 – Build and install pure native SwiftUI & AppKit macOS Menu Bar app via SPM
#       (Multi-Monitor Popover Geometry Fix & Live 1-Second Countdown Timer)
set -e
...
# Sync SPM sources with v12 native Swift code
cp "${SCRIPT_DIR}/app_main_v12.swift" "${SCRIPT_DIR}/Sources/AntigravityUsageApp/app_main.swift"

echo "==> Compiling pure native SwiftUI executable (v12 SPM Release Build)..."
...
<!-- v12 – Info.plist for Pure SwiftUI & AppKit Menu Bar App (Dual Quota Status & Live Countdown) -->
<plist version="1.0">
<dict>
...
echo "==> Launching 100% Pure Native Antigravity Usage v12..."
open "${APP_DIR}"

echo "==> Done! Antigravity Usage v12 is running."
