// v4 – Ultra-clean native macOS Menu Bar Popover Snap-out runner
import Cocoa
import WebKit
...
class AppDelegate: NSObject, NSApplicationDelegate, NSMenuDelegate, NSPopoverDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // 1. Configure Compact WKWebView
        let popoverWidth: CGFloat = 360
        let popoverHeight: CGFloat = 415
        ...
        // 2. Configure Native Popover (Apple-grade snap-out)
        popover = NSPopover()
        popover.appearance = NSAppearance(named: .darkAqua)
        popover.behavior = .transient // Snaps closed when clicking anywhere outside
        popover.animates = true       // Native smooth macOS popover animation
        ...
        if let resourcePath = Bundle.main.path(forResource: "index", ofType: "html") {
            ...
            let devUrl = URL(fileURLWithPath: "/Users/dad/git/antigravity-usage-monitor/index_v4.html")
        ...
        // Initial launch: Snap out popover immediately
