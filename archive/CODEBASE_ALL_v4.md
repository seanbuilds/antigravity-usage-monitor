...
<!-- v4 – Consolidated file containing 100% pure native SwiftUI & AppKit source code, obsidian palette, manifests, and documentation -->
...
## Table of Contents
- [README_v8.md](#readme-v8md) — *Project Overview & Pure Native Documentation*
...
- [app_main_v9.swift](#app-main-v9swift) — *100% Pure Native SwiftUI & AppKit Menu Bar Application (Obsidian Palette & Zero Double-Blur)*
...
- [build_app_v9.sh](#build-app-v9sh) — *Pure Native Release Build, Packaging & Signing Script*
...
## app_main_v9.swift
**Description:** 100% Pure Native SwiftUI & AppKit Menu Bar Application (Obsidian Palette & Zero Double-Blur)  
**Path:** `app_main_v9.swift` | **Lines:** 1369
...
**Path:** `build_app_v9.sh` | **Lines:** 106

```bash
#!/usr/bin/env bash
# v9 – Build and install 100% pure native SwiftUI & AppKit macOS Menu Bar application via SPM
set -e
...
# Sync SPM sources with v9 native Swift code
cp "${SCRIPT_DIR}/app_main_v9.swift" "${SCRIPT_DIR}/Sources/AntigravityUsageApp/app_main.swift"

echo "==> Compiling 100% pure native SwiftUI executable (v9 SPM Release Build)..."
...
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<!-- v9 – Info.plist for Pure SwiftUI & AppKit Menu Bar App -->
<plist version="1.0">
<dict>
...
echo "==> Launching 100% Pure Native Antigravity Usage v9..."
open "${APP_DIR}"

echo "==> Done! Antigravity Usage v9 is running."
