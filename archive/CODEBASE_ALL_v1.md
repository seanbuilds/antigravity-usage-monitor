...
<!-- v1 – Single consolidated file containing all source code, manifests, and documentation -->
...
## Table of Contents
- [README_v7.md](#readme-v7md) — *Project Overview & Documentation*
...
- [app_main_v6.swift](#app-main-v6swift) — *Native macOS Menu Bar Runner, Unsnap HUD & Desktop Widget*
...
- [index_v6.html](#index-v6html) — *WebKit Popover Dashboard User Interface*
- [widget_v6.html](#widget-v6html) — *WebKit Compact Desktop Widget User Interface*
- [antigravity_usage_v3.py](#antigravity-usage-v3py) — *Hardened Python CLI & Cross-Device Quota Daemon*
- [build_app_v6.sh](#build-app-v6sh) — *Release Build, Packaging & Code-Signing Script*
- [com.antigravity.usage_v3.plist](#comantigravityusage-v3plist) — *macOS LaunchAgent Daemon Configuration*

---

## README_v7.md
**Description:** Project Overview & Documentation  
**Path:** `README_v7.md` | **Lines:** 96
...
**Path:** `app_main_v6.swift` | **Lines:** 655

```swift
// v6 – Hardened Native macOS Menu Bar Popover, Unsnap HUD & Desktop Widget with App Group sync
import Cocoa
import WebKit
import WidgetKit
...
class AppDelegate: NSObject, NSApplicationDelegate, NSMenuDelegate, NSPopoverDelegate, NSWindowDelegate, WKScriptMessageHandler {
    ...
    func ensureDaemonRunning() {
        ...
        task.arguments = ["-c", "curl -s --connect-timeout 1 http://127.0.0.1:3007/healthz || launchctl load ~/Library/LaunchAgents/com.antigravity.usage_v3.plist 2>/dev/null"]
        task.launch()
    }
...
## index_v6.html
**Description:** WebKit Popover Dashboard User Interface  
**Path:** `index_v6.html` | **Lines:** 530

```html
<!DOCTYPE html>
<!-- v6 – Ultra-clean Apple-native design with Unsnap, Desktop Widget & Legal Disclaimer -->
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  <div id="groups-container">
    <!-- Clean cards populated dynamically -->
  </div>
  ...
  <script>
    ...
    function renderQuota(data) {
      ...
      userEmail.textContent = data.account || 'Active Session';
    ...
    async function fetchQuota(force = false) {
      ...
      try {
        ...
        updatedLabel.textContent = 'Retrying connection...';
      } finally {
    ...
    btnUnsnap.addEventListener('click', () => {
      if (window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.appAction) {
        window.webkit.messageHandlers.appAction.postMessage({
          action: isUnsnapped ? "snap" : "unsnap"
        });
      }
    });
    ...
    btnWidget.addEventListener('click', () => {
      if (window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.appAction) {
        window.webkit.messageHandlers.appAction.postMessage({ action: "toggleWidget" });
      }
    });
...
**Path:** `widget_v6.html` | **Lines:** 271

```html
<!DOCTYPE html>
<!-- v6 – Ultra-compact Apple Desktop Widget for Google Antigravity -->
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <div class="meters">
      <div class="meter-row">
        <div class="meter-meta">
          ...
          <span class="pct" id="g-pct" style="color: var(--green)">84%</span>
        </div>
        <div class="bar-bg">
          <div class="bar-fill green" id="g-bar" style="width: 84%"></div>
        </div>
      </div>
      ...
      <div class="meter-row">
        <div class="meter-meta">
          ...
          <span class="pct" id="c-pct" style="color: var(--green)">98%</span>
        </div>
        <div class="bar-bg">
          <div class="bar-fill green" id="c-bar" style="width: 98%"></div>
        </div>
      </div>
    </div>
  </div>
...
## antigravity_usage_v3.py
**Description:** Hardened Python CLI & Cross-Device Quota Daemon  
**Path:** `antigravity_usage_v3.py` | **Lines:** 675

```python
#!/usr/bin/env python3
# v3 – Security hardening, in-memory token cache, thread synchronization, dynamic LAN IP
"""
antigravity_usage_v3.py
...
def read_credential_from_system() -> dict:
    ...
    candidates = [
        os.path.join(home, ".gemini", "antigravity", "tokens.json"),
        os.path.join(home, ".gemini", "tokens.json"),
        os.path.join(home, ".config", "antigravity", "tokens.json"),
        os.path.join(home, ".antigravity", "tokens.json"),
    ]
...
def render_dashboard(data: dict, color: bool = True) -> str:
    ...
    if fetched_at:
        try:
            ...
            time_str = fetched_at
        lines.append(f"{c_dim}Updated: {time_str}  |  Host: {data.get('host', 'Google Cloud Code')}{c_reset}")
...
**Path:** `build_app_v6.sh` | **Lines:** 108

```bash
#!/usr/bin/env bash
# v6 – Build and install native macOS Menu Bar Popover application via SPM & Package.swift
set -e
...
echo "==> Compiling native Swift executable (v6 SPM Release Build)..."
...
cp "${SCRIPT_DIR}/index_v6.html" "${APP_DIR}/Contents/Resources/index.html"
cp "${SCRIPT_DIR}/widget_v6.html" "${APP_DIR}/Contents/Resources/widget.html"
...
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<!-- v6 – Info.plist with LSUIElement and App Group entitlements -->
<plist version="1.0">
<dict>
...
echo "==> Launching updated Antigravity Usage (v6 SPM + Unsnap + App Group Sync)..."
open "${APP_DIR}"

echo "==> Done! Antigravity Usage v6 is running."

```
---

## com.antigravity.usage_v3.plist
**Description:** macOS LaunchAgent Daemon Configuration  
**Path:** `~/Library/LaunchAgents/com.antigravity.usage_v3.plist` | **Lines:** 43

```xml
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<!-- v3 – Hardened LaunchAgent: throttled restart, isolated log directory, antigravity_usage_v3.py -->
<plist version="1.0">
<dict>
    <key>Label</key>
    ...
    <array>
        ...
        <string>/Users/dad/git/antigravity-usage-monitor/antigravity_usage_v3.py</string>
        <string>--serve</string>
        <string>--port</string>
        <string>3007</string>
        <string>--bind</string>
