...
<!-- v3 – Consolidated file containing 100% pure native SwiftUI & AppKit source code, manifests, and documentation -->
...
- [app_main_v8.swift](#app-main-v8swift) — *100% Pure Native SwiftUI & AppKit Menu Bar Application*
...
- [build_app_v8.sh](#build-app-v8sh) — *Pure Native Release Build, Packaging & Signing Script*
...
## app_main_v8.swift
**Description:** 100% Pure Native SwiftUI & AppKit Menu Bar Application  
**Path:** `app_main_v8.swift` | **Lines:** 1314
...
**Path:** `build_app_v8.sh` | **Lines:** 106

```bash
#!/usr/bin/env bash
# v8 – Build and install 100% pure native SwiftUI & AppKit macOS Menu Bar application via SPM
set -e
...
# Sync SPM sources with v8 native Swift code
cp "${SCRIPT_DIR}/app_main_v8.swift" "${SCRIPT_DIR}/Sources/AntigravityUsageApp/app_main.swift"

echo "==> Compiling 100% pure native SwiftUI executable (v8 SPM Release Build)..."
...
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<!-- v8 – Info.plist for Pure SwiftUI & AppKit Menu Bar App -->
<plist version="1.0">
<dict>
...
echo "==> Launching 100% Pure Native Antigravity Usage v8..."
open "${APP_DIR}"

echo "==> Done! Antigravity Usage v8 (Pure SwiftUI & AppKit) is running."
