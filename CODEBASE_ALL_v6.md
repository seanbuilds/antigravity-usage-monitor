...
<!-- v6 – Consolidated file containing 100% pure native SwiftUI & AppKit source code, dual status indicator, 4-rate-limit matrix, deterministic 360° refresh, manifests, and documentation -->
...
## Table of Contents
- [README_v10.md](#readme-v10md) — *Project Overview & Pure Native Documentation*
